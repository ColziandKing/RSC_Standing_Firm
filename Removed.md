...
[
    {
        "name": "Cultured",
        "friendBonusUniques": [
            "[+4 Culture] <before the [Medieval era]>",
            "[+8 Culture] <starting from the [Medieval era]> <before the [Industrial era]>",
            "[+14 Culture] <starting from the [Industrial era]>"
        ],
        "allyBonusUniques": [
    ...
    },
    {
        "name": "Mercantile",
        "friendBonusUniques": [
            "[+3 Happiness] <before the [Medieval era]>",
            "[+4 Happiness] <starting from the [Medieval era]>"
        ],
        "allyBonusUniques": [
            "[+3 Happiness] <before the [Medieval era]>",
            "[+4 Happiness] <starting from the [Medieval era]>",
    ...
    {
        "name": "Militaristic",
        "friendBonusUniques": ["Provides military units every ≈[17] turns"],
        "allyBonusUniques": ["Provides military units every ≈[14] turns"],
        "color": [255, 0, 0]
    },
    {
        "name": "Religious",
        "friendBonusUniques":  [
            "[+4 Faith] <before the [Medieval era]>",
            "[+8 Faith] <starting from the [Medieval era]> <before the [Industrial era]>",
            "[+14 Faith] <starting from the [Industrial era]>"
        ],
        "allyBonusUniques":  [
